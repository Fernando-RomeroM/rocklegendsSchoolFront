        ...
        <div>
            <div className="texto1">
                <ul className="texto11">
                    <li className="texto12">Bateria</li>
                    <li className="texto13">Sin ti los demás se pierden</li>
                    <li className="texto14"> . Bienvenido a nuestro curso de batería que, al igual que el resto de cursos en nuestro sitio web, es totalmente gratis y online, para que puedas aprender a tocar la batería a tu ritmo, poco a poco y desde cero, desde la comodidad de tu casa.

Se trata como siempre de un curso de batería para principiantes, pensado para que cualquier persona, ya sea que no sepa nada o que tenga ya algunos conceptos básicos, pueda aprender a tocar el instrumento siguiendo nuestros vídeos y practicando a su ritmo.

Estamos seguros de que siguiendo esta serie de tutoriales sobre como tocar la batería, con práctica, dedicación y constancia, serás capaz de ir de cero a 100 en unas cuantas semanas o meses, a medida que vayas avanzando a lo largo del curso. Te sorprenderá ver los avances cuando dentro de unos meses eches la vista atrás y recuerdes como empezabas a aprender con los primeros vídeos! La batería es un instrumento que requiere bastante paciencia al principio y bastante práctica, ya que muchas veces debemos hacer ejercicios de coordinación a los que no estamos acostumbrados. Puede que los primeros días que practiquemos nos parezca imposible, pero en un par de días de práctica puedes ver como empiezas a coordinar y a hacer de manera fácil ejercicios que en un primer momento parecían difíciles.</li>
